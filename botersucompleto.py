...
/* Aggiunta per gestire lo spazio in fondo per il footer */
...
# ... (tutto il tuo codice per PDF, Langchain, Embeddings, Catena LLM) ...

# --- LOGICA CHAT (La parte finale del tuo codice) ---
if domanda_utente:
    risposta = catena.invoke(domanda_utente)
    st.write(risposta)
